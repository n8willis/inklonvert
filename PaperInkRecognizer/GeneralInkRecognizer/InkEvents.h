...
#else
// Eventhandler for the Ink Analyser Events
class InkAnalyserEvents : public _IAnalysisEvents
{
public:
    ...
    virtual HRESULT STDMETHODCALLTYPE IntermediateResultsUpdated( 
        /* [in] */ IInkAnalyzer *pInkAnalyzer,
        /* [in] */ IAnalysisStatus *pAnalysisStatus) {
        // This is a place holder designed to be overridden by
        //  user of this class.
    ...
    virtual HRESULT STDMETHODCALLTYPE Activity( void)  {
        // This is a place holder designed to be overridden by
        //  user of this class.
        return (S_OK);
	}
    
    virtual HRESULT STDMETHODCALLTYPE UpdateStrokesCache( 
    ...
    virtual  HRESULT STDMETHODCALLTYPE ReadyToReconcile( void) {
        // This is a place holder designed to be overridden by
        //  user of this class.
        return (S_OK);
	}
    ...
    // Set up connection between sink and Ink Collector
    HRESULT AdviseInkAnalyser(
        IInkAnalyzer *pIInkAnalyser)
    {
        HRESULT hr = S_OK;
        ...
        if (NULL == m_pIConnectionPoint)
        {
            // Get the connection point container
            IConnectionPointContainer *pIConnectionPointContainer;
            hr = pIInkAnalyser->QueryInterface(
                IID_IConnectionPointContainer, 
                (void **) &pIConnectionPointContainer);
            ...
            // Find the connection point for Ink Analyser events
            hr = pIConnectionPointContainer->FindConnectionPoint(
                __uuidof(_IAnalysisEvents), &m_pIConnectionPoint);
    ...
    // Remove the connection of the sink to the Ink Analyzer
...
class MathPanelEvents : public _IMathInputControlEvents
{
public:
        ...
        void **ppvObject)
    {
        ...
        {
DebugBreak();// TODO Check this path
            // Assert that the free threaded marshaller has been
            // initialized.  It is necessary to call Init() before
            // invoking this method.
            assert(NULL != m_punkFTM);// TODO Remove this variable
    ...
    // Set up connection between sink and Math Panel
    HRESULT AdviseMathInputPanel(
        IMathInputControl *pIMathInputControl)
    {
        ...
        if (NULL == m_pIConnectionPoint)
        {
            ...
            {
                // Hook up sink to connection point
                hr = m_pIConnectionPoint->Advise(pUnknown, &m_dwCookie);
            }
     ...
     HRESULT UnadviseMathInputPanel()
    {
        HRESULT hr = S_OK;
